...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $clave = $_POST['clave'];
    $dni = $_POST['dni'];
    $perfil = "usuario"; // Valor por defecto para el campo perfil
    $telefono = $_POST['telefono'];
    $confirm_clave = $_POST['confirm_password'];
    $foto_rostro = "https://i.postimg.cc/pXHjkv6K/blank-profile-picture-973460-960-720.png"; // URL por defecto
    ...
    if ($clave !== $confirm_clave) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            $sql = "INSERT INTO usuarios (email, nombre, clave, dni, perfil, telefono, foto_rostro) 
                    VALUES ('$email', '$nombre', '$hashed_clave','$dni','$perfil','$telefono', '$foto_rostro')";
                ...
                echo "<script>
                    document.addEventListener('DOMContentLoaded', function() {
                        Swal.fire({
                            ...
                            window.location.href = 'http://localhost/nuevo/contrase%C3%B1a/index.php';
                        });
                    });
                </script>";
            } else {
...
<body>
    ...
    <div class="login-container1">
        ...
        <p>¿Ya tienes cuenta? <a class="link" href="indexlogin.php" >Inicia sesión aquí</a></p>
        </div>
    </div>
    <footer class="footer">
