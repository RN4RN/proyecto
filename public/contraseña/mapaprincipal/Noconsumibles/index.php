...
$sql = "SELECT id_equipo, nombre_equipo FROM equipos WHERE tipo_equipo = 'Permanente'";
$result = $conexion->query($sql);
$equipos = $result->fetch_all(MYSQLI_ASSOC);

// CONSULTA COMPLETA CON NOMBRES
// Cambia esta parte del código donde obtienes los equipos
// Cambia esta parte del código donde obtienes los equipos
$sql = "SELECT e.*, 
        ...
        WHERE e.tipo_equipo = 'Permanente'";  // <-- Aquí agregas el filtro
$result = $conexion->query($sql);
?>
...
<script>
    // En tu script.js o dentro de <script>:
